          ...
          <Card vertical={4} horizontal={4}>
            ...
            <InlineList spacingBetween={1}>
              <Button
                ...
                small
                onPress={
                  () => openModal(TRADE_COIN_MODAL, { type: 'buy', name, price: priceLabel }) // 모달 본문의 TradeCoinPage 컴포넌트에 type, price 프로퍼티값을 전달
                }
              >
                매도
              </Button>
              <Button
                small
                onPress={
                  () => openModal(TRADE_COIN_MODAL, { type: 'sell', name, price: priceLabel }) // 모달 본문의 TradeCoinPage 컴포넌트에 type, price 프로퍼티값을 전달
                }
              >
                매수
              </Button>
